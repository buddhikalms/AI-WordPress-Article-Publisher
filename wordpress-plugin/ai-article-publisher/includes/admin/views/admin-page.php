			...
			<div class="aia-sidebar__stack">
				...
				<section class="aia-card">
					<div class="aia-card__header">
						...
						<p><?php esc_html_e('Featured image generated by OpenAI or pulled from a Google Doc.', 'ai-article-publisher'); ?></p>
					</div>
					<div id="aia-image-empty" class="aia-empty-state">
						<p><?php esc_html_e('No featured image yet. Generate one in Manual Studio or import from a Google Doc.', 'ai-article-publisher'); ?></p>
					</div>
